...
public class com_pdg_WhatsApp_model_ChatsRealmProxy extends com.pdg.WhatsApp.model.Chats
    ...
    private RealmList<String> nombreUsersRealmList;
    ...
    public RealmList<String> realmGet$nombreUsers() {
        proxyState.getRealm$realm().checkIfValid();
        // use the cached value if available
        if (nombreUsersRealmList != null) {
            return nombreUsersRealmList;
        } else {
            OsList osList = proxyState.getRow$realm().getValueList(columnInfo.nombreUsersColKey, RealmFieldType.STRING_LIST);
            nombreUsersRealmList = new RealmList<java.lang.String>(java.lang.String.class, osList, proxyState.getRealm$realm());
            return nombreUsersRealmList;
        }
    }
    ...
    public void realmSet$nombreUsers(RealmList<String> value) {
        if (proxyState.isUnderConstruction()) {
            ...
            if (proxyState.getExcludeFields$realm().contains("nombreUsers")) {
                return;
            }
        }
    ...
    public static com.pdg.WhatsApp.model.Chats createOrUpdateUsingJsonObject(Realm realm, JSONObject json, boolean update)
        ...
        if (obj == null) {
            ...
            if (json.has("nombreUsers")) {
                excludeFields.add("nombreUsers");
            }
            if (json.has("id")) {
                if (json.isNull("id")) {
        ...
        ProxyUtils.setRealmListWithJsonObject(realm, objProxy.realmGet$nombreUsers(), json, "nombreUsers", update);
        if (json.has("imagen")) {
    ...
    public static com.pdg.WhatsApp.model.Chats createUsingJsonStream(Realm realm, JsonReader reader)
        ...
        while (reader.hasNext()) {
            ...
            } else if (name.equals("nombreUsers")) {
                objProxy.realmSet$nombreUsers(ProxyUtils.createRealmListWithJsonStream(java.lang.String.class, reader));
    ...
    public static long insert(Realm realm, com.pdg.WhatsApp.model.Chats object, Map<RealmModel,Long> cache) {
        ...
        RealmList<java.lang.String> nombreUsersList = ((com_pdg_WhatsApp_model_ChatsRealmProxyInterface) object).realmGet$nombreUsers();
        if (nombreUsersList != null) {
            OsList nombreUsersOsList = new OsList(table.getUncheckedRow(objKey), columnInfo.nombreUsersColKey);
            for (java.lang.String nombreUsersItem : nombreUsersList) {
                if (nombreUsersItem == null) {
                    nombreUsersOsList.addNull();
                } else {
                    nombreUsersOsList.addString(nombreUsersItem);
                }
            }
        }
    ...
    public String toString() {
        ...
        stringBuilder.append("}");
        stringBuilder.append(",");
        stringBuilder.append("{nombreUsers:");
        stringBuilder.append("RealmList<String>[").append(realmGet$nombreUsers().size()).append("]");
        stringBuilder.append("}");
        stringBuilder.append(",");
