...
public class Estado2RecyclerAdapter extends RecyclerView.Adapter <Estado2RecyclerAdapter.RecyclerDataHolder> {

    RealmResults<Estado> realmChat;


    public Estado2RecyclerAdapter(RealmResults<Estado> realmChat, Context baseContext) {
