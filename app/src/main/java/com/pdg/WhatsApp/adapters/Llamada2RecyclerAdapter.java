...
public class Llamada2RecyclerAdapter extends RecyclerView.Adapter <Llamada2RecyclerAdapter.RecyclerDataHolder> {

    RealmResults<Llamada> realmChat;


    public Llamada2RecyclerAdapter(RealmResults<Llamada> realmChat, Context baseContext) {
